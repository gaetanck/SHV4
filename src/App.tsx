        ...
        return (
            <div className="container mx-auto p-4">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center mb-4 gap-2">
                    ...
                    <div className="flex gap-2">
                        <button onClick={handleOpenAddPlayerModal} className="flex items-center gap-2 bg-pink-500 text-white py-2 px-4 rounded-lg hover:bg-pink-600 transition-colors text-sm whitespace-nowrap">
                            <UserPlus size={16} />
                        ...
                        }))} className="flex items-center gap-2 bg-gray-200 text-gray-700 py-2 px-4 rounded-lg hover:bg-gray-300 transition-colors text-sm whitespace-nowrap">
                            <RefreshCw size={16} />
